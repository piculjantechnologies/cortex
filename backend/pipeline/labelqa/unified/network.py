...
# unified/qa_model.py at commit 07f31da. AGPL-3.0-only.
#
# STAGES, WORST_Q, LEVELS_FOR_STRIDE, FREEZE_CHOICES, Trunk and FusionNet are
# copied verbatim; GhostBatchNorm and ghostify (training only) are left out.
# The repository's `import dataset as _dataset` is replaced by the VOC
# configuration in voc.py, and only the imports the code needs are kept.
"""FusionNet: the network of the unified VOC checkpoint (see MODEL.md)."""
import pickle
