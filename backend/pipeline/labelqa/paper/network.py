...
# paper/neural_network.py (NUM_CLASSES, _trunk, Net) and paper/coco_corrnet.py
# (CorrNet) at commit 07f31da. AGPL-3.0-only.
#
# The code below is copied verbatim; only the imports it needs are kept, and
# coco_corrnet.py's `from neural_network import Net` is satisfied by Net above
# it. "README item N" in its comments refers to paper/README.md of that
# repository.
"""CorrNet: the network of the paper's COCO checkpoint (see MODEL.md)."""
import torch
